...
| [gh-cs-rename](https://github.com/maxbeizer/gh-cs-rename) | Interactively rename open GitHub Codespaces from one edit... | Go | `gh ext install maxbeizer/gh-cs-rename` |
...
| [gh-hush](https://github.com/maxbeizer/gh-hush) | Safe, explainable, policy-driven GitHub notification tria... | Go | `gh ext install maxbeizer/gh-hush` |
| [gh-msft](https://github.com/maxbeizer/gh-msft) | Read and triage your Microsoft 365 mail and calendar from... | Go | `gh ext install maxbeizer/gh-msft` |
...
*Catalog generated by [gh-fleet](https://github.com/maxbeizer/gh-fleet) on 2026-08-24.*
